...
String q="delete from categorias where id_categoria = "+id_categoria;
...
out.println("<FORM ACTION=borrarCategorias.jsp METHOD=post>");
out.println("ID_CATEGORIA ELIMINAR:<INPUT TYPE=TEXT NAME=ID_CATEGORIA><BR>");
